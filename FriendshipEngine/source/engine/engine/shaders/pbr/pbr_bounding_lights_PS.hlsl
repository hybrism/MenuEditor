...
Texture2D aNormalTexture : register(t4);
...
PixelOutput main(PixelInputType input)
{
    ...
    float3 cameraPosition = GetCameraPosition().xyz;
    float3 toEye = normalize(cameraPosition.xyz - worldPosition.xyz).xyz;
