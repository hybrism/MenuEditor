...
#pragma region VS
	...
	// Default PBR Vertex Shader
	{
		...
		{ "BINORMAL",	0, DXGI_FORMAT_R32G32B32_FLOAT,		0,	D3D11_APPEND_ALIGNED_ELEMENT,	D3D11_INPUT_PER_VERTEX_DATA,	0 },
		{ "TANGENT",	0, DXGI_FORMAT_R32G32B32_FLOAT,		0,	D3D11_APPEND_ALIGNED_ELEMENT,	D3D11_INPUT_PER_VERTEX_DATA,	0 },
		{ "TEXCOORD",	1, DXGI_FORMAT_R32_FLOAT,			1,	D3D11_APPEND_ALIGNED_ELEMENT,	D3D11_INPUT_PER_INSTANCE_DATA,	1 }, // time
		};



		DxBufferDesc instanceBufferDesc;
		instanceBufferDesc.stride = sizeof(float);
		instanceBufferDesc.offset = 0;


		D3D11_BUFFER_DESC objectBufferDesc;
		objectBufferDesc.Usage = D3D11_USAGE_DYNAMIC;
		objectBufferDesc.ByteWidth = sizeof(VfxMeshInstanceData);
		...
		instanceBufferDesc.desc = &objectBufferDesc;

		current.Init("vfx_default", type, layout, sizeof(layout), &instanceBufferDesc);
	}
#pragma endregion //!VS
#pragma region PS
